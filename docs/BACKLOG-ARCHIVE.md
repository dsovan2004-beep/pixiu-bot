# PixiuBot Backlog — Archive (historical)

Archived 2026-06-23 (Producer backlog cleanup). Sprint 9/10 phases + the Limo
Path strategic roadmap, retained for history only. **This predates the
332-trade negative-EV postmortem** — figures and plans here are historical
context, NOT current truth. The ACTIVE backlog is [docs/BACKLOG.md](BACKLOG.md);
current status is [docs/STATUS.md](STATUS.md).
